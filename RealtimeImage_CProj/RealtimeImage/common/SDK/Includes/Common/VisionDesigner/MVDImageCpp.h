...
extern "C" {
    ...
    MVD_CPP_API int _stdcall CreateImageInstance(VisionDesigner::IMvdImage** ppImageInstance);
    ...
    MVD_CPP_API int _stdcall DestroyImageInstance(VisionDesigner::IMvdImage* pImageInstance);
