...
// 目标跟踪类
const static int MVD_ALG_STS_ERR_MVB2D_TRACK_PKG_NUM_OVERFLOW  = 0x10309001;       ///< ch: 目标数目超出限制
const static int MVD_ALG_STS_ERR_MVB2D_TRACK_ROI_RECT_OVERFLOW = 0x10309002;       ///< ch: 跟踪计数RECT区域设置超出图像范围
