 ...
 * Copyright information: HangZhou Hikrobot Technology Co., Ltd. All Right Reserved.
 *
...
#define   IMVS_EC_MODULE_COARSE_OVER_SCORE                  0xE000032C  // CH: 粗糙度阈值大于最小匹配分数 | EN: The roughness threshold is greater than the minimum match score
...
#define   IMVS_EC_ENCRYPT_DONGLE_OLD_EXPIRE                 0xE0000701  // CH: 算法平台老版本狗试用时间过期 | EN: The trial license of dongle in the algorithm platform with old version is expired
