...
extern "C" 
{
	...
	// ***设置模块输入***
	VMMODULEFRAME_API int __stdcall VM_M_SetInputString(IN int nModuleId, IN const char* szName, IN int nIndex, IN const char* pValue);
	VMMODULEFRAME_API int __stdcall VM_M_SetInputInt(IN int nModuleId, IN const char* szName, IN int nIndex, IN int nValue);
	VMMODULEFRAME_API int __stdcall VM_M_SetInputFloat(IN int nModuleId, IN const char* szName, IN int nIndex, IN float fValue);
	VMMODULEFRAME_API int __stdcall VM_M_SetInputImage(IN int nModuleId, IN const char* szName, IN int nIndex, IN const IMAGE_DATA* pImageData);
	VMMODULEFRAME_API int __stdcall VM_M_SetInputPointset(IN int nModuleId, IN const char* szName, IN int nIndex, IN void* pData, IN int nDataLen);
	VMMODULEFRAME_API int __stdcall VM_M_SetInputBytes(IN int nModuleId, IN const char* szName, IN int nIndex, IN void* pData, IN int nDataLen);
